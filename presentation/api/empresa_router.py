...
@router.delete("/{empresa_id}/membros/{usuario_id_alvo}", status_code=204)
...
@router.put("/{empresa_id}/membros/{usuario_id_alvo}/role")
...
@router.get("/{empresa_id}/solicitacoes")
...
@router.post("/{empresa_id}/solicitacoes", status_code=201)
...
@router.put("/{empresa_id}/solicitacoes/{solicitacao_id}")
...
@router.post("/{empresa_id}/papeis", status_code=201)
...
@router.put("/{empresa_id}/papeis/{papel_id}")
...
@router.delete("/{empresa_id}/papeis/{papel_id}", status_code=204)
